...
**Steps to use OR brief understanding :**
 ...
 2. Create an object of type GenericActions,which should be used to call methods in it. Use the methods/functions defined in GenericActions. 

***NOTE:*** You will need PropertyDetails in all methods, as it operates on attributes     of property.
